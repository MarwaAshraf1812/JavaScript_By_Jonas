...
/* 1.3 Below is the nested ratings array that contains two other arrays.
    ...
    the ratings variable should store a number 4.19, and the ratingsCount
...
const [firstStarRating, secondStarRating, threeStarRatings = 0] = ratingStars;
console.log(firstStarRating, secondStarRating, threeStarRatings);